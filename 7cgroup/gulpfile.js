...
gulp.task('coffee', function() {
  gulp.src('assets/js/*.coffee')
    ...
    .pipe(gulp.dest('assets/js/'))
		util.log(util.colors.yellow('Coffe compiled'));  // Output to terminal
});
...
//////////////////////////////////////////////////////////////////////
	...
	gulp.task('javascripts', function(){
		gulp.src([
			...
			'assets/js/plugins/*.js'])										// Gets all the user JS _*.js from assets/js
...
gulp.task('watch', function(){
	...
	gulp.watch("bower_components/**/*.scss", ['sass']);				// Watch and run sass on changes
	...
	gulp.watch("assets/js/**/*.coffee", ['coffee', 'javascripts']);		// Watch and minify images on changes

});

gulp.task('default', ['sass', 'coffee', 'jshint', 'javascripts', 'copy', 'watch']);
